...
<form action="PlayAdd" method="post">
影片名称：<input type="text" name="name"/><br/>
影片类型：<select name="type">
...
影片简介：<input type="text" name="text"/><br/>
影片时长：<select name="time">
		</select></br>
上映状态：<select name="status">
  			<option  value="1">上映中</option>
  			<option  value="2">未上映</option>
  			<option  value="3">已下映</option>
		</select></br>
影片票价：<select name="priece">
